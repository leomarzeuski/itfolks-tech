...
/**
 * Guarded wrapper around the React Bits SoftAurora (WebGL) background. Fills its
 * parent; mounts only when WebGL is available and reduced motion isn't
 * requested, failing silently otherwise.
 */
export function SoftAuroraBackground(props: ComponentProps<typeof SoftAurora>) {
